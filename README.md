## Map (Домашнее задание к лекции «Контейнеры») [![Build status](https://ci.appveyor.com/api/projects/status/iruae23fyek0dcjn?svg=true)](https://ci.appveyor.com/project/bas27/fpyajs-map-container)
